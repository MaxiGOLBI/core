...
export default function GastosPage() {
  // ── View mode ──
  const [view, setView] = useState('list'); // 'list' | 'categories'
        ...
        <div className="relative flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button onClick={() => setView(v => v === 'categories' ? 'list' : 'categories')}
              className="bg-white/25 border border-white/50 text-white px-3 py-2 rounded-xl text-sm font-semibold hover:bg-white/35 transition-all">
              {view === 'categories' ? '← Volver' : 'Categorías'}
            </button>
            {view !== 'categories' && (
              <button onClick={handleExport}
                className="bg-white/25 border border-white/50 text-white px-3 py-2 rounded-xl text-sm font-semibold hover:bg-white/35 transition-all flex items-center gap-1.5">
