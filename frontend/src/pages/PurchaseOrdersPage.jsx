      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-700 to-cyan-500 rounded-2xl px-5 py-5 sm:px-8 sm:py-6 shadow-lg">
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-blue-100 text-sm mt-1">Gestión de órdenes de compra y recepción de mercadería</p>
          </div>
          <button onClick={() => { setEditOrder(null); setShowForm(true); }}
            className="bg-white text-blue-700 px-4 py-2 rounded-xl text-sm font-bold shadow-sm hover:bg-blue-50 transition-all flex-shrink-0">
            + Nuevo pedido
          </button>
        </div>
      </div>
