  ...
  const NavLinks = ({ mobile = false }) => {
    ...
    return (
      <>
        ...
        {canSeeCaja && (
          <NavLink to="/cashier" className={cls} onClick={close}>
            {({ isActive }) => (
              <>
        ...
        {hasRole('cajero', 'encargado', 'dueno') && !!user?.branch_id && (
          <NavLink to="/cash" className={cls} onClick={close}>
            {({ isActive }) => (<><IconApertura active={isActive} />Apertura</>)}
          </NavLink>
        )}
        {hasRole('encargado', 'dueno') && (
          <NavLink to="/cash/movements" className={cls} onClick={close}>
            {({ isActive }) => (<><IconMovimientos active={isActive} />Movimientos</>)}
          </NavLink>
        )}
        {hasRole('encargado', 'dueno') && (
        ...
        {hasRole('dueno') && (
          <NavLink to="/cash/flow" className={cls} onClick={close}>
            {({ isActive }) => (<><IconFlujoCaja active={isActive} />Flujo de Caja</>)}
          </NavLink>
        )}
        {hasRole('dueno') && (
