...
import GastosSucursalPage from './pages/GastosSucursalPage';
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <Routes>
        ...
        <Route path="/gastos-sucursal" element={<ProtectedRoute roles={['encargado', 'cajero']}><GastosSucursalPage /></ProtectedRoute>} />
        ...
        <Route path="/fiscal" element={<ProtectedRoute roles={['cajero', 'encargado', 'dueno']}><FiscalPage /></ProtectedRoute>} />
        <Route path="/fiscal/receipts" element={<Navigate to="/fiscal" replace />} />
        <Route path="/tax-withholdings" element={<Navigate to="/fiscal" replace />} />
        <Route path="/my-commissions" element={<ProtectedRoute roles={['vendedor', 'encargado']}><CommissionHistory /></ProtectedRoute>} />
